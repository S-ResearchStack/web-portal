...
type EditorProps<D extends EditorItem, S extends EditorSection<D>> = {
  ...
  renderPublish: (params: ReturnType<typeof usePublish>) => ReactElement;
  renderHeadEditor: () => ReactElement;
  renderItemsEditor: (item: EditorItemProps<D>) => ReactElement;
  renderSectionActions?: (item: RenderSectionActionsParams<D, S>) => ReactElement;
