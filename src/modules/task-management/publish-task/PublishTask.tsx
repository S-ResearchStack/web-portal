...
import { DurationObject, durationUnitFirstKey, durationUnitSecondKey } from 'src/common/components/Duration/DurationForm';
...
const PublishTask: FC<PublishTaskProps> = ({ open, onClose, type }) => {
  ...
  const [noExpiration, setNoExpiration] = useToggle(false);
  const [durationObject, setDurationObject] = useState<DurationObject>(DEFAULT_DURATION_VALUE);
  ...
  return (
    <BackdropOverlay id="publish-task" open={open}>
      <Centred>
        <Fade in={open} unmountOnExit>
          <Container data-testid="publish-task">
              ...
              <Form>
                ...
                {frequency !== ScheduleFrequency.ONE_TIME && (
                  <Series
                    ...
                    onChangeExpiration={setNoExpiration}
                  />
                )}
                <Occurrence
                  type={type}
                  ...
                  onDurationChange={setDurationObject}
            ...
            <Footer>
              ...
              <Actions timeErrorActive={!isTimeWarningHidden}>
                <Button
                  fill="text"
                  double="left"
                  data-testid="publish-task-cancel"
                  width={164}
                  onClick={onClose}
                >
                  Cancel
                ...
                <Button
                  fill="solid"
                  data-testid="publish-task-publish"
                  width={164}
