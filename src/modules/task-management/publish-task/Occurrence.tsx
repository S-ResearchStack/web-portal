...
import DurationForm, { DurationObject } from 'src/common/components/Duration/DurationForm';
...
interface TaskOccurrenceProps {
  ...
  onDurationChange: (duration: DurationObject) => void;
...
const Occurrence: FC<TaskOccurrenceProps> = ({
  ...
  return (
    <FormBlock label="Occurrence">
      ...
      <FormSection>
        ...
        <InputFieldShell>
          <ValidDurationDropdown
            data-testid="valid-duration-dropdown"
      ...
      <FormSection>
        <DurationForm duration={durationObject} onChange={onDurationChange} />
      </FormSection>
    </FormBlock>
  );
};
