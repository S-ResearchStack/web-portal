...
import { useAutoScroll, UseAutoScrollParams } from 'src/common/hooks/useAutoScroll';
...
export type DraggableItemRenderer<T> = (options: DraggableItemRendererProps<T>) => ReactElement;
