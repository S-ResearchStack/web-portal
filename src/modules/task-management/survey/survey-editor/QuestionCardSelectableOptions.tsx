...
const QuestionCardSelectableOptions: FC<QuestionCardSelectableOptionsProps> = ({
      ...
      >
        ...
        <OptionActions>
          ...
          <DragIconButton
            ...
            aria-label="Drag and Drop Option"
          />
        </OptionActions>
      </OptionContainer>
    );
  ...
  return (
    <>
      ...
      />
      <AddOptionButton data-testid="add-option-button" fill="text" icon={<PlusIcon />} onClick={clickAddOption}>Add option</AddOptionButton>
      {withOtherOption && (
