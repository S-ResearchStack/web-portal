  ...
  return (
    <VisitDateTimeContainer>
      ...
      <InputFieldShell
        ...
        error={isInvalidTime ? 'Select valid time' : undefined}
      >
        <TimeDropdown
...
export const VisitDateTime = ({
  ...
  useEffect(() => {
    ...
    setEndDateTime([endTs ? getDate(endTs) : undefined, endTs ? getMinutes(endTs) : undefined]);
  }, [startTs, endTs]);
  ...
  const handleChange = useCallback(
    (list: [VisitDateTimeDuration, VisitDateTimeDuration]) => {
      onChange(list.map(durationToTs) as VisitDateTimeDuration);
    },
    [onChange]
  );
