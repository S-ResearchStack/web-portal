...
export const avgHeartRateFluctuationsMockData = [
  {
    name: 'female',
    dataKey: 'day 1',
    value: '4',
...
export const getAvgHeartRateFluctuationsMock = () =>
  API.mock.sqlResponse(avgHeartRateFluctuationsMockData);

API.mock.provideEndpoints({
  getAvgHeartRateFluctuations: getAvgHeartRateFluctuationsMock,
});
