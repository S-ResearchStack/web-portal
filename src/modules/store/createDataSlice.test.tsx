...
describe('Tests for createDataSlice', () => {
  describe('Store tests', () => {
    ...
    it('should support cache by fetch arguments mechanism', () => {
  ...
  describe('Hook tests', () => {
    ...
    it('should catch error when data loading', async () => {
    ...
    it('should catch connection error when data loading', async () => {
